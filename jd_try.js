...
let goodFilters = "教程@门票@软件@英语@辅导@电信@移动@联通@培训@靓美@脚气@文胸@卷尺@看房@鞋带@丰胸@课程培训@体验班@精品课@御夫王@苗霸@北海游@购房@键盘膜@种子@三元催化@男用喷剂@万向轮@档案袋@癣@中年@老太太@妇女@私处@孕妇@卫生巾@卫生条@课@培训@阴道@生殖器@肛门@狐臭@少女内衣@胸罩@少女@女性内衣@女性内裤@女内裤@女内衣@女孩@钢圈@婴儿@儿童@幼儿@网课@网校@电商@手机壳@钢化膜@网络课程@疣@避孕套@按键贴@背膜@后膜@背贴@贝尔思力@卡薇尔@三角裤@痔疮@神皂@美少女@英语@俄语@四级@六级@四六级@在线网络@在线@阴道炎@宫颈@螺丝@延时@糜烂@打底裤@手机膜@早早孕@延时喷剂@鱼@增长@增时@壮阳@女用@男用@狗@艾草@灸@贴@膏@药北海@印度@油@在线@膜".split('@')
let minPrice = 60
let maxPrice = 10000
let iszhongcao=false;
...
async function filterGoodList() {
	...
	console.log(`⏰ 开始吧，zhb，当前共有${$.goodList.length}个商品`)
...
async function tryGoodList() {
	...
	for (let i = 0; i < $.goodList.length && $.running; i++) {
		...
		let deng=parseInt(Math.random()*(61-10)+10);
		if(iszhongcao){
			console.log(`⏰ 上一个需要种草官等待7秒`)
			await $.wait(7000)
		}else{
			console.log(`⏰ 等待${$.totalTry}， ${deng} 秒`)
			await $.wait(deng*1000)
		}
		// 关注完毕，即将试用
		await doTry(good)
	}
